    ...
    fn map_context_projects_from_surface_scene_without_parsing_claims() {
        let scene = SurfaceSceneResponse {
            ...
            layers: vec![SceneLayer {
                ...
                scale_mode: "nearby".to_string(),
                priority: 1,
                show_review_metrics: true,
                enabled_by_default: true,
                rank: 1,
                features: vec!["around_this_home:schools:place-school".to_string()],
                available_count: 1,
                shown_count: 1,
    ...
    fn map_context_projects_red_flag_lines_from_surface_scene() {
        let scene = SurfaceSceneResponse {
            ...
            layers: vec![SceneLayer {
                ...
                scale_mode: "area".to_string(),
                priority: 1,
                show_review_metrics: false,
                enabled_by_default: true,
                rank: 1,
                features: vec!["around_this_home:red_flags:line-one".to_string()],
                available_count: 1,
                shown_count: 1,
                fill_state: FillState::Filled,
            }],
            ...
            receipts: vec![SceneReceipt {
                ...
                source_type: "OpenStreetMap".to_string(),
                source_display: crate::dag_config::source_display_metadata("OpenStreetMap"),
