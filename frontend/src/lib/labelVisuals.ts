...
const LABEL_VISUALS: Record<string, LabelVisual> = {
  ...
  amenities: { title: "Amenities", classToken: "community", family: "nearby", icon: "essentials" },
  ...
  maintenance: { title: "Maintenance", classToken: "community", family: "comparable", icon: "builder" },
