...
Object.defineProperty(globalThis, "fetch", {
  value: () => {
    ...
    return Promise.resolve(Response.json([{ ...fixtureProperties[0], id, price: 12_000_000 }]));
  },
  configurable: true,
});
...
test("a runtime refresh bypasses the cached and in-flight property catalog", async () => {
  ...
  resolveInitialFetch?.(Response.json([{ ...fixtureProperties[0], id: "old-home", price: 10_000_000 }]));
